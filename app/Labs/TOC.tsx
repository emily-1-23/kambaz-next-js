...
export default function TOC() {
 ...
 return (
   <Nav variant="pills">
     ...
     <NavItem>
       <NavLink href="https://github.com/emily-1-23/kambaz-next-js.git">My GitHub</NavLink>
     </NavItem>
     <NavItem>
       <NavLink href="https://kambaz-node-server-app-a15c.onrender.com">Render</NavLink>
     </NavItem>
   </Nav>
);}
